...
| [Elgato Stream Deck Mini](https://www.elgato.com/en/stream-deck-mini) | **sdmini** | `alias sd_1 input /ja "Provoke" <t>`<br> Keys are numbered left-to-right, top-to-bottom. i.e. On the Stream Deck Mini, top left is `sdmini_1`, top right is `sdmini_3`, and bottom right is `sdmini_6`. |
