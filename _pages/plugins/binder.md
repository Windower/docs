...
| [Elgato Stream Deck XL](https://www.elgato.com/en/stream-deck-xl) | **sdxl** | `alias sdxl_1 input /ja "Provoke" <t>`<br> Keys are numbered left-to-right, top-to-bottom. i.e. On a standard 15-key Stream Deck, top left is `sdxl_1`, top right is `sdxl_8`, and bottom right is `sdxl_32`. |
| [Elgato Stream Deck Mini](https://www.elgato.com/en/stream-deck-mini) | **sdmini** | `alias sd_1 input /ja "Provoke" <t>`<br> Keys are numbered left-to-right, top-to-bottom. i.e. On a standard 15-key Stream Deck, top left is `sdmini_1`, top right is `sdmini_3`, and bottom right is `sdmini_6`. |
